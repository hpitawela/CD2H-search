					...
					<c:when test="${param.mode == 'concept'}">
						...
						<rdf:foreachConcept var="x" queryString="${rewrittenQuery}">
							<rdf:concept>
								...
								<li><a href="visualSearch.jsp?query=${fn:replace(fn:replace(param.query,'&','%26'), concept, cui)}${query_suffix}"><rdf:conceptCUI/></a> - <rdf:conceptPhrase/>
								<ol class="bulletedList">
									<li>Super concepts:
										<ol class="bulletedList">
										<rdf:foreachSuperconcept var="">
											<c:set var="supercui"><rdf:superconceptCUI/></c:set>
											<li><a href="visualSearch.jsp?query=${fn:replace(fn:replace(fn:replace(param.query,'&','%26'), concept, supercui), cui, supercui)}${query_suffix}"><rdf:superconceptCUI/></a> - <rdf:superconceptPhrase/>
									...
									<li>Sub concepts:
										...
										<rdf:foreachSubconcept var="">
											...
											<li><a href="visualSearch.jsp?query=${fn:replace(fn:replace(fn:replace(param.query,'&','%26'), concept, subcui), cui, subcui)}${query_suffix}"><rdf:subconceptCUI/></a> - <rdf:subconceptPhrase/>
